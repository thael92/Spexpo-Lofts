   ...
   useEffect(() => {
      ...
      if (id) {
         ...
         fetchPropertyById(id).then(data => {
            ...
            if (data) {
               fetchProperties(1, 4, { type: data.type }).then(res => {
   ...
   return (
      <div className="bg-white min-h-screen pb-20 pt-20">
         <LocationModal
            ...
            initialAddress={`${property.address.street}, ${property.address.neighborhood}`}
         />
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
               <div>
                  ...
                  <div className="flex items-center gap-2 text-gray-500 mt-4 text-sm font-medium">
                     ...
                     {property.address.street}, {property.address.neighborhood} - São Paulo, SP
                  </div>
               </div>
               ...
               <div className="lg:w-2/3">
                  ...
                  <div className="mb-16">
                     ...
                     <div className="relative h-80 rounded-3xl overflow-hidden shadow-xl group cursor-pointer" onClick={() => setIsMapOpen(true)}>
                        <iframe
                           title="Map Preview"
                           src={property.map_iframe_url || `https://maps.google.com/maps?q=${encodeURIComponent(property.address.street)}&t=&z=15&ie=UTF8&iwloc=&output=embed`}
